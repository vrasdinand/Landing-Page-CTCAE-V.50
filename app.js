document.addEventListener('DOMContentLoaded', function() {
    ...
    // Tambahkan event listener untuk menanggapi perubahan nilai dropdown kedua
      selectOption2.addEventListener('change', function() {
    // Dapatkan nilai yang dipilih
    var selectedValue2 = selectOption2.value;
    // Tampilkan nilai yang dipilih
    ...
    var urlApi3 = 'https://ctcae.000webhostapp.com/tampil_data.php';
